...
?>
        <div class="grid-x grid-margin-x">
            <div class="large-12 medium-12 small-12 cell">
                <p><a href="siteusers.php" class="button"><?php echo $strBack?>&nbsp;<i class="fas fa-backward fa-xl"></i></a></p>
            </div>
        </div>
        <form method="post"  action="siteusers.php?mode=new">
            ...
            <div class="grid-x grid-margin-x">
                <div class="large-1 medium-1 small-1 cell">
                    ...
                    <input name="utilizator_CRM" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_CRM" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppCMS?> </label>
                    <input name="utilizator_CMS" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_CMS" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppAdministrative?> </label>
                    <input name="utilizator_Administrative" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Administrative" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppBilling?> </label>
                    <input name="utilizator_Billing" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Billing" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppSales?> </label>
                    <input name="utilizator_Sales" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Sales" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppClients?></label>
                    <input name="utilizator_Clients" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Clients" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppProjects?></label>
                    <input name="utilizator_Projects" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Projects" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppShop?> </label>
                    <input name="utilizator_Shop" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Shop" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppLab?></label>
                    <input name="utilizator_Lab" type="radio" value="1" /> <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Lab" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppElearning?> </label>
                    <input name="utilizator_Elearning" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Elearning" type="radio" value="0" checked><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppTransfer?> </label>
                    <input name="utilizator_Transfer" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Transfer" type="radio" value="0" checked><?php echo $strNo?>
</div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppHelpDesk?> </label>
                    <input name="utilizator_Helpdesk" type="radio" value="1" />
                    <?php echo $strYes?>&nbsp;&nbsp;<input name="utilizator_Helpdesk" type="radio" value="0" checked><?php echo $strNo?>
                </div>
            </div>
...
?>
        ...
        <form method="post"  action="siteusers.php?mode=edit&cID=<?php echo $row['utilizator_ID']?>">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'], ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <div class="grid-x grid-margin-x">
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppCRM?> </label>
                    <input name="utilizator_CRM" type="radio" value="1" <?php If ($row["utilizator_CRM"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_CRM" type="radio" value="0" <?php If ($row["utilizator_CRM"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppCMS?> </label>
                    <input name="utilizator_CMS" type="radio" value="1" <?php If ($row["utilizator_CMS"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_CMS" type="radio" value="0" <?php If ($row["utilizator_CMS"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppAdministrative?> </label>
                    <input name="utilizator_Administrative" type="radio" value="1" <?php If ($row["utilizator_Administrative"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Administrative" type="radio" value="0" <?php If ($row["utilizator_Administrative"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppBilling?> </label>
                    <input name="utilizator_Billing" type="radio" value="1" <?php If ($row["utilizator_Billing"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Billing" type="radio" value="0" <?php If ($row["utilizator_Billing"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppSales?> </label>
                    <input name="utilizator_Sales" type="radio" value="1" <?php If ($row["utilizator_Sales"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Sales" type="radio" value="0" <?php If ($row["utilizator_Sales"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppClients?> </label>
                    <input name="utilizator_Clients" type="radio" value="1" <?php If ($row["utilizator_Clients"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Clients" type="radio" value="0" <?php If ($row["utilizator_Clients"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppProjects?> </label>
                    <input name="utilizator_Projects" type="radio" value="1" <?php If ($row["utilizator_Projects"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Projects" type="radio" value="0" <?php If ($row["utilizator_Projects"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppShop?> </label>
                    <input name="utilizator_Shop" type="radio" value="1" <?php If ($row["utilizator_Shop"]==1) echo "checked"?>/><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Shop" type="radio" value="0" <?php If ($row["utilizator_Shop"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppLab?> </label>
                    <input name="utilizator_Lab" type="radio" value="1" <?php If ($row["utilizator_Lab"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Lab" type="radio" value="0" <?php If ($row["utilizator_Lab"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppElearning?> </label>
                    <input name="utilizator_Elearning" type="radio" value="1" <?php If ($row["utilizator_Elearning"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Elearning" type="radio" value="0" <?php If ($row["utilizator_Elearning"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppTransfer?> </label>
                    <input name="utilizator_Transfer" type="radio" value="1" <?php If ($row["utilizator_Transfer"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Transfer" type="radio" value="0" <?php If ($row["utilizator_Transfer"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
                <div class="large-1 medium-1 small-1 cell">
                    <label><?php echo $strAppHelpDesk?> </label>
                    <input name="utilizator_Helpdesk" type="radio" value="1" <?php If ($row["utilizator_Helpdesk"]==1) echo "checked"?> /><?php echo $strYes?>&nbsp;&nbsp;
                    <input name="utilizator_Helpdesk" type="radio" value="0" <?php If ($row["utilizator_Helpdesk"]==0) echo "checked"?>><?php echo $strNo?>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
