...
$nsql="DELETE FROM activitati_clienti WHERE ID_Activitate=" .$_GET['cID']. ";";
...
//insert new user
	...
	$mSQL = "INSERT INTO activitati_clienti(";
...
Else
{// edit
$strWhereClause = " WHERE activitati_clienti.ID_Activitate=" . $_GET["cID"] . ";";
$query= "UPDATE activitati_clienti SET activitati_clienti.Activitate_Denumire='" .str_replace("'","&#39;",$_POST["Activitate_Denumire"]) . "' ," ;
$query= $query . " activitati_clienti.Activitate_Descriere='" .str_replace("'","&#39;",$_POST["Activitate_Descriere"]) . "' "; 
...
$query="SELECT * FROM activitati_clienti WHERE ID_Activitate=$_GET[cID]";
...
$query="SELECT * FROM activitati_clienti";
$result=ezpub_query($conn,$query);
