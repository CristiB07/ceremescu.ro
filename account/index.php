...
<div class="grid-x grid-margin-x">
    <div class="large-12 medium-12 small-12 cell text-center">
        <form method="POST" action="<?php echo $strSiteURL ?>/account/validate.php<?php if(isset($_GET['redirect'])) echo '?redirect=' . urlencode($_GET['redirect']); ?>">
            <fieldset>
                <legend>
                ...
                <div class="grid-x grid-margin-x">
                    ...
                    <div class="large-4 medium-4 small-4 cell text-center">
                        <div class="callout secondary">
                            ...
                            <p><a href="<?php echo $strSiteURL?>/account/forgotpassword.php" class="button"><?php echo $strForgotPassword ?></a>
                                <a href="<?php echo $strSiteURL?>/account/createaccount.php" class="button"><?php echo $strAddNewAccount?></a>
                            </p>
                        </div>
                    </div>
                    <div class="large-4 medium-4 small-4 cell">
