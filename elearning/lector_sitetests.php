...
?>
            ...
            <div class="grid-x grid-margin-x">
                <div class="large-4 medium-4 small-4 cell">
                    <label><?php echo $strTitle?>
                        <input name="elearning_tests_name" type="text" class="required" />
                    </label>
                </div>
		...
		?>
                            <option selected value="<?php echo $rss["Course_id"]?>"><?php echo $rss["course_name"]?>
                            </option>
                            <?php }?>
                        </select></label>
                </div>
                <div class="large-2 medium-2 small-2 cell">
                    <label><?php echo $strScore?>
                        <input name="elearning_tests_score" type="text" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strDetails?>
                        <textarea name="elearning_tests_description" style="width:100%;   height: 200;"
                            id="myTextEditor" class="myTextEditor"></textarea>
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
...
?>
		...
		?>
            ...
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label> <?php echo $strDetails?>
                        <textarea name="elearning_tests_description" style="width:100%;" id="myTextEditor"
                            class="myTextEditor"><?php echo $row['test_description'] ?></textarea>
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
...
{
echo "<a href=\"lector_sitetests.php?mode=new\" class=\"button\">$strAdd&nbsp;<i class=\"fa-xl fa fa-plus\" title=\"$strAdd\"></i></a>";
