 ...
 <div class="grid-x grid-padding-x">
	<div class="large-3 medium-3 small-3 cell">
	 ...
	 <label><?php echo $strScore?></label>
	  ...
	  <label><?php echo $strHint?></label>
	  <input name="question_hint" Type="text" size="30"  />
	  </div>
	</div>
	<div class="grid-x grid-padding-x">
	<div class="large-12 medium-12 small-12 cell">
		<?php echo $strQuestion?><br />
	  <textarea name="question_question" style="width:100%;   height: 200;" id="myTextEditor" class="myTextEditor"></textarea>
	</div>	
	</div>	
	 <div class="grid-x grid-padding-x">
...
$row=ezpub_fetch_array($result);
?>
<form Method="post" id="users" Action="lector_sitetestsquestions.php?mode=edit&qID=<?php echo $row['question_ID']?>" ><table id="rounded-corner" summary="<?php echo $strQuestion?>" width="100%">
  <div class="grid-x grid-padding-x">
	<div class="large-3 medium-3 small-3 cell">
	  <label><?php echo $strTest?></label>
	   <select name="question_test" class="required">
		...
		?>
          <option selected value="<?php echo $rss["test_ID"]?>"><?php echo $rss["test_name"]?></option>
		<?php } else {?>
          <option  value="<?php echo $rss["test_ID"]?>"><?php echo $rss["test_name"]?></option>
		<?php }}?>
        </select>	
		...
		<div class="large-3 medium-3 small-3 cell">
		  <label><?php echo $strScore?></label>
	  <input name="question_score" Type="text" size="4" value="<?php echo $row["question_score"]?>" class="required" />
		</div>
		<div class="large-3 medium-3 small-3 cell">
	  <label><?php echo $strType?></label>
	   <select name="question_type" class="required">
           <option value="1000"><?php echo $strPick?></option>
           <option value="0" <?php If ($row["question_type"]==0) {echo "selected";}?> ><?php echo $strOpened?></option>
           <option value="1" <?php If ($row["question_type"]==1) {echo "selected";}?>><?php echo $strSingleOption?></option>
           <option value="2" <?php If ($row["question_type"]==2) {echo "selected";}?>><?php echo $strMultipleOption?></option>
        </select>
		</div>
		<div class="large-3 medium-3 small-3 cell">	 
	  <label><?php echo $strHint?></label>
	  <input name="question_hint" Type="text" size="30" value="<?php echo $row["question_hint"]?>" />
		</div>
		</div>
		<div class="grid-x grid-padding-x">
	<div class="large-12 medium-12 small-12 cell">
	 <?php echo $strQuestion?><br />
	  <textarea name="question_question" style="width:100%;   height: 200;" id="myTextEditor" class="myTextEditor"><?php echo $row["question_question"]?></textarea>
		</div>
		</div>
	<div class="grid-x grid-padding-x">
	<div class="large-12 medium-12 small-12 cell">
...
Else
{
echo "<a href=\"lector_sitetestsquestions.php?mode=new&tID=$_GET[tID]\" class=\"button\">$strAdd&nbsp;<i class=\"large fa fa-plus\" title=\"$strAdd\"></i></a><br/>";
...
if ($numar2==0)
{
	echo "<a href=\"lector_sitetestoptions.php?mode=new&qID=$row[question_ID]\" class=\"button\">$strAdd&nbsp;<i class=\"large fa fa-plus\" title=\"$strAdd\"></i></a><br/>";
echo $strNoRecordsFound;
}
Else {
		echo "<a href=\"lector_sitetestoptions.php?mode=new&qID=$row[question_ID]\"><i class=\"large fa fa-plus\" title=\"$strAdd\"></i></a><br/>";
?>
<table width="100%">
	      <thead>
    	<tr>
