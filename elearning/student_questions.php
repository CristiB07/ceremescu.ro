...
//insert nlew question
	...
	$mSQL = $mSQL . "lesson_id,";
    $mSQL = $mSQL . "student_question,";
	$mSQL = $mSQL . "course_id)";

	$mSQL = $mSQL . "Values(";
	$mSQL = $mSQL . "'" .$uid . "', ";
	$mSQL = $mSQL . "'" .$lid . "', ";
	$mSQL = $mSQL . "'" .str_replace("'","&#39;",$_POST["elearning_student_question"]) . "', ";
	$mSQL = $mSQL . "'" .$courseID . "') ";
...
<!--
function delayer(){
    window.location = \"student_sitelessons.php?lID=$lid\"
}
//-->
</script>
...
<div class=\"callout primary\">
  ...
  ?>
       ...
       <div class="grid-x grid-margin-x">
			  <div class="large-12 medium-12 small-12 cell">
<form method="POST" action="student_questions.php?lID=<?php echo $_GET['lID']?>">
    <label>
        <?php echo $strQuestion?>
</label>
        <textarea name="elearning_student_question" id="myTextEditor" class="myTextEditor"></textarea>
</div>
</div>
<div class="grid-x grid-margin-x">
              <div class="large-12 medium-12 small-12 cell">
