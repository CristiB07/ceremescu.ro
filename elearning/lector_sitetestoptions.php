...
?>
<form Method="post" id="users" Action="lector_sitetestoptions.php?mode=new&qID=<?php echo $_GET['qID']?>" >
	      <div class="grid-x grid-margin-x">
			  <div class="large-12 medium-12 small-12 cell">
	  <label><?php echo $strOption?><label/>
	  <textarea name="quizoption_option" style="width:100%;   height: 200;" id="myTextEditor" class="myTextEditor"></textarea>
</div>
</div>
        <div class="grid-x grid-margin-x">
          <div class="large-2 medium-2 small-2 cell">
	  <label><?php echo $strScore?></label>
	  <input name="quizoption_score" Type="text" size="4" class="required" />
</div>
          <div class="large-10 medium-10 small-10 cell">
	  <label><?php echo $strComment?></label>
	  <input name="quizoption_comment" Type="text" size="30"  />
</div>
</div>
        <div class="grid-x grid-margin-x">
...
$row=ezpub_fetch_array($result);
?>
<form Method="post" id="users" Action="lector_sitetestoptions.php?mode=edit&oID=<?php echo $row['quizoption_ID']?>" >
	      <div class="grid-x grid-margin-x">
			  <div class="large-12 medium-12 small-12 cell">

<label><?php echo $strOption?></label>
	  <textarea name="quizoption_option" style="width:100%;   height: 200;" id="myTextEditor" class="myTextEditor"><?php echo $row["quizoption_option"]?></textarea>
</div>
</div>
        <div class="grid-x grid-margin-x">
          <div class="large-2 medium-2 small-2 cell">
	 <label><?php echo $strScore?></label>
	  <input name="quizoption_score" Type="text" size="4" value="<?php echo $row["quizoption_score"]?>" class="required" />
</div>
          <div class="large-10 medium-10 small-10 cell">
	  <label><?php echo $strComment?></label>
	  <input name="quizoption_comment" Type="text" size="30" value="<?php echo $row["quizoption_comment"]?>" />
</div>
</div>
        <div class="grid-x grid-margin-x">
        <div class="large-12 medium-12 small-12 cell"><p align="center">
...
Else
{
echo "<a href=\"lector_sitetestoptions.php?mode=new&qID=$_GET[qID]\" class=\"button\">$strAdd&nbsp;<i class=\"large fa fa-plus\" title=\"$strAdd\"></i></a><br/>";
