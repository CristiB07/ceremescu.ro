...
<li>
    ...
    <ul class="menu">
        ...
        <li><a href="<?php echo $strSiteURL ?>/admin/backupdb.php"><i class="fas fa-save"></i>
...
<ul class="menu">
<li><a href="<?php echo $strSiteURL ?>/account/myprofile.php"><i class="fas fa-user-circle fa-xl"></i>&nbsp;<?php echo $strMyProfile?></a>
</li>
<?php
if ($shop=='1') {
?>
...
<li><a href="<?php echo $strSiteURL ?>/elearning/student_siteschedules.php"><i
            class="fa-xl fa fa-calendar"></i>&nbsp;<?php echo $strOtherCourses?></a></li>
<li><a href="<?php echo $strSiteURL ?>/elearning/student_mydiplomas.php"><i
            class="fa-xl fa fa-graduation-cap"></i>&nbsp;<?php echo $strMyDiplomas?></a></li>
</ul>
</li>
...
elseif ($role=='TRAINER')
            			{
			?>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_myprofile.php"><i
            class="fas fa-user"></i>&nbsp;<?php echo $strMyProfile?></a></li>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_sitecourses.php"><i
            class="fa fa-book"></i>&nbsp;<?php echo $strMyCourses?></a>
    <?php
...
if ($nume==0)
{?>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_sitecourses.php?mode=new"><i
            class="fas fa-plus"></i>&nbsp;<?php echo $strAddNewCourse?></a></li>
...
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_studentquestions.php"><i
            class="fas fa-question"></i>&nbsp;<?php echo $strQuestions?></a></li>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_siteschedules.php"><i
            class="fas fa-calendar"></i></i>&nbsp;<?php echo $strSchedules?></a></li>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_sitelessons.php"><i
            class="fas fa-book-open"></i>&nbsp;<?php echo $strLessons?></a></li>
<li><a href="<?php echo $strSiteURL ?>/elearning/lector_sitetests.php"><i
            class="fas fa-hourglass-half"></i>&nbsp;<?php echo $strTests?></a></li>
