...
<li>
    ...
    <ul class="menu">
        ...
        <li><a href="<?php echo $strSiteURL ?>/clients/siteclientsbranch.php"><i class="far fa-file-alt"></i><?php echo $strBranchContracts?></a></li>
...
<li>
    ...
    <ul class="menu">
        <li><a href="<?php echo $strSiteURL ?>/billing/siteinvoices.php"><i class="fas fa-file-invoice"></i><?php echo $strInvoices?></a></li>
        <li><a href="<?php echo $strSiteURL ?>/billing/sitebulkinvoices.php"><i class="fas fa-clone"></i><?php echo $strBulkInvoices?></a></li>
        ...
        <li><a href="<?php echo $strSiteURL ?>/billing/einvoices.php"><i class="fas fa-upload"></i><?php echo $strEinvoices?></a></li>
        <li><a href="<?php echo $strSiteURL ?>/billing/receivedeinvoices.php"><i class="fas fa-inbox"></i><?php echo $strReceivedEinvoices?></a></li>
        <li><a href="<?php echo $strSiteURL ?>/billing/verifymessages.php?mode=verify"><i class="fas fa-inbox"></i><?php echo $strEinvoicesMessages?></a></li>
...
<?php if ($wastemanagement==1)
    {?>
<li>
    <a href="#"><?php echo $strWasteManagement?></a>
    <ul class="menu">
...
<?php if ($elearning==1 AND $ttype==1)
    {?>
<li>
...
<li>
    ...
    <ul class="menu">
        <li><a href="<?php echo $strSiteURL ?>/wasteman/sitewastereporting.php"><i class="far fa-file-excel"></i><?php echo $strWasteReporting?></a></li>
        <li><a href="<?php echo $strSiteURL ?>/wasteman/yearlyreporting.php"><i class="far fa-file-excel"></i><?php echo $strYearlyWasteReporting?></a></li>
        <li> <li><a href="<?php echo $strSiteURL ?>/packman/sitepackagesanex1a.php"><i class="far fa-file-word"></i><?php echo $strAnnex1Table1?></a></li>
        <li> <li><a href="<?php echo $strSiteURL ?>/packman/sitepackagesanex1b.php"><i class="far fa-file-word"></i><?php echo $strAnnex1Table2?></a></li>
        <li> <li><a href="<?php echo $strSiteURL ?>/packman/sitepackanexsubmission.php"><i class="far fa-file-word"></i><?php echo $strExportAnnex?></a></li>
    </ul>
</li>
<?php }
if ($documents==1)
