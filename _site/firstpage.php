...
<div class="orbit" role="region" aria-label="CertPlus" data-orbit>
 <div class="orbit-wrapper">
    <div class="orbit-controls">
      <button class="orbit-previous"><span class="show-for-sr"><?php echo $strPrevious?></span>&#9664;&#xFE0E;</button>
      <button class="orbit-next"><span class="show-for-sr"><?php echo $strNext?></span>&#9654;&#xFE0E;</button>
    </div>
    <ul class="orbit-container">
			<li class="is-active orbit-slide">
				<figure class="orbit-figure">
					...
					Proceduri și formulare pentru certificarea sistemelor de management al calității în baza standardului ISO 9001:20015
					</figcaption>
				</figure>
			</li>
				...
				<figure class="orbit-figure">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management al mediului în baza standardului ISO 14001:2015
					</figcaption>
				</figure>
					</li>
					<li class="orbit-slide">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management al sănătății și securității în muncă în baza ISO 45001:2018
					</figcaption>
				</figure>
					</li>
					<li class="orbit-slide">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management al siguranței alimentare în baza ISO 22000:2019 sau HACCP
					</figcaption>
				</figure>
					</li>					
					<li class="orbit-slide">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management al securității informațiilor în baza ISO 27001:2022
					</figcaption>
				</figure>
					</li>				
					<li class="orbit-slide">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management al continuității afacerilor în baza ISO 22301:2019
					</figcaption>
				</figure>
					</li>		
					<li class="orbit-slide">
					...
					<figcaption class="orbit-caption">
					Proceduri și formulare pentru certificarea sistemelor de management anti-mită în baza ISO 37001:2016
					</figcaption>
				</figure>
					</li>
					</ul>
...
While ($row=ezpub_fetch_array($result2)){
	  ...
	  $vatprc=$vatrat+1;
	echo "<div class=\"large-3 medium-3 small-3 cell \"><div class=\"column\" data-equalizer-watch>";
