...
document.getElementById("feed").innerHTML = data;
        ...
        <div class="grid-x grid-margin-x">
            <div class="large-12 medium-12 small-12 cell">
                <p><a href="feeds.php" class="button"><?php echo $strBack?>&nbsp;<i
        ...
        <div class="grid-x grid-margin-x">
            <div class="large-12 medium-12 small-12 cell">
                ...
                <div class="input-group">
                    ...
                    <input class="input-group-field" type="text" name="feed" id="feed"
                        placeholder="<?php echo $strFeedURL?>">
        ...
        <form method="post"  action="feeds.php?mode=new">
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strURL?>
                        <input name="feed_url" id="feed_url" type="text" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strFeedSiteURL?>
                        <input name="feed_site_url" id="feed_site_url" type="text" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strTitle?>
                        <input name="feed_titlu" id="feed_titlu" type="text" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-8 medium-8 small-8 cell">
                    <label><?php echo $strImage?>
                        <input name="feed_image_url" id="feed_image_url" type="text" class="required" />
                    </label>
                </div>
                <div class="large-2 medium-2 small-2 cell">
                    <label><?php echo $strWidth?>
                        <input name="feed_image_w" id="feed_image_w" type="text" class="required" />
                    </label>
                </div>
                <div class="large-2 medium-2 small-2 cell">
                    <label><?php echo $strHeight?>
                        <input name="feed_image_h" id="feed_image_h" type="text" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
  ...
  document.getElementById("response").innerHTML = err.message;
        ...
        <div class="grid-x grid-margin-x">
            <div class="large-12 medium-12 small-12 cell">
                ...
                <div class="input-group">
                    <span class="input-group-label"><?php echo $strURL?></span>
                    <input class="input-group-field" type="text" name="feed_url" id="feed"
                        value="<?php echo $row["feed_url"]?>">
                    <div class="input-group-button">
                        <button id="btn1" class="button"><i
                                class="fas fa-search"></i>&nbsp;<?php echo $strCheck ?></button>
                    </div>
        ...
        <form method="post"  action="feeds.php?mode=edit&cID=<?php echo $row['feed_ID']?>">
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strURL?>
                        <input name="feed_url" type="text" id="feed_url" value="<?php echo $row['feed_url'] ?>"
                            class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strFeedSiteURL?>
                        <input name="feed_site_url" type="text" id="feed_site_url"
                            value="<?php echo $row['feed_site_url'] ?>" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strTitle?>
                        <input name="feed_titlu" type="text" id="feed_titlu" value="<?php echo $row['feed_titlu'] ?>"
                            class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-8 medium-8 small-8 cell">
                    <label><?php echo $strImage?>
                        <input name="feed_image_url" type="text" id="feed_image_url"
                            value="<?php echo $row['feed_image_url'] ?>" class="required" />
                    </label>
                </div>
                <div class="large-2 medium-2 small-2 cell">
                    <label><?php echo $strWidth?>
                        <input name="feed_image_w" id="feed_image_w" type="text"
                            value="<?php echo $row['feed_image_w'] ?>" class="required" />
                    </label>
                </div>
                <div class="large-2 medium-2 small-2 cell">
                    <label><?php echo $strHeight?>
                        <input name="feed_image_h" id="feed_image_h" type="text"
                            value="<?php echo $row['feed_image_h']?>" class="required" />
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell">
                    <label><?php echo $strDetails?>
                        <textarea name="feed_descriere" id="feed_descriere"
                            rows="5"><?php echo $row['feed_descriere'] ?></textarea>
                    </label>
                </div>
            </div>
            <div class="grid-x grid-margin-x">
                <div class="large-12 medium-12 small-12 cell"> <input type="submit" value="<?php echo $strAdd?>"
...
echo " <div class=\"grid-x grid-margin-x\">
     <div class=\"large-12 medium-12 small-12 cell\">
<a href=\"feeds.php?mode=new\" class=\"button\">$strAdd&nbsp;<i class=\"fa-xl fa fa-plus\" title=\"$strAdd\"></i></a></div></div>";
